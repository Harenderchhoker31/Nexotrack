...
import youtubeIcon from '../images/video.png';

const Footer = () => {
  return (
    <footer className="bg-black text-white py-16">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="flex gap-50 mb-12 text-sm text-white/80">
          ...
          <div className="flex gap-40">
            ...
            <div>
              ...
              <ul className="space-y-1">
                ...
                <li className="hover:text-white transition">Learn</li>
        ...
        <div className="flex justify-center gap-6 mb-8">
          ...
          <img src={instagramIcon} alt="Instagram" className="w-7 h-7 hover:scale-110 transition-transform bg-white" />
          <img src={linkedinIcon} alt="LinkedIn" className="w-7 h-7 hover:scale-110 transition-transform rounded bg-white" />
          <img src={youtubeIcon} alt="YouTube" className="w-7 h-7 hover:scale-110 transition-transform bg-white" />
        </div>
